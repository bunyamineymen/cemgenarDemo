...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    public void RequestBannerAd()
    {
...
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-9180051608295548/2147036010";
#elif UNITY_IPHONE
        ...
        bannerView.OnAdLoaded += (sender, args) =>
        {
            ...
            //GameObject bannerImage = GameObject.Find("BANNER(Clone)").transform.GetChild(0).gameObject;
            //RectTransform bannerRectTransform = bannerImage.GetComponent<RectTransform>();
            //Rect bannerRect = bannerRectTransform.rect;
            //bannerRect.height = 50.0f;

            CanvasScaler bannerScaler = GameObject.Find("BANNER(Clone)").GetComponent<CanvasScaler>();
            Debug.Log("x = " + bannerScaler.referenceResolution.x + ", y = " + bannerScaler.referenceResolution.y);
            bannerScaler.matchWidthOrHeight = 0;
    ...
    public void RequestAndLoadInterstitialAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-9180051608295548/4251057816";
#elif UNITY_IPHONE
    ...
    public void RequestAndLoadRewardedAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-9180051608295548/2770455183";
#elif UNITY_IPHONE
